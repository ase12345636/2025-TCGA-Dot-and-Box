...
if show_each_loss:
    plt.plot(global_step[moving_average_width:],
             v_loss_ma[moving_average_width:], color=green_color)
    plt.plot(global_step[moving_average_width:],
             p_loss_ma[moving_average_width:], color=blue_color)
    ...
    plt.plot(global_step[moving_average_width:],
             p_v_loss_ma[moving_average_width:], color=yellow_color)
    ...
    legend_p_v_loss = mlines.Line2D(
        [], [], color=yellow_color, label='p_loss + v_loss')
